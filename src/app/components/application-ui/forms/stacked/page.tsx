...
export default function StackedForm() {
  return (
    <Container className="min-h-screen py-20">
      <Breadcrumb className="mb-2" items={['Application UI', 'Forms', 'Stacked']} />
      <h1 className="mb-10 text-2xl font-extrabold">Stacked</h1>

      <div className="grid gap-10 rounded-lg border bg-white px-4 py-24 md:px-10">
        <div>
